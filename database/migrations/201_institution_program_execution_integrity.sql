...
BEGIN
  ...
  IF EXISTS (
    ...
    RAISE EXCEPTION 'migration 201 postcheck failed: server-only program RPC ACL mismatch'
      USING ERRCODE='23514';
  END IF;
