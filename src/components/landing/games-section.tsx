...
const GAMES = [
  {
    ...
    sub: 'TYT · AYT-SAY · LGS',
    desc: 'Sayılar, problemler, geometri, türev, integral — TYT\'den AYT Sayısal\'a her düzey.',
  ...
  },
  {
    ...
    sub: 'TYT · AYT-EA · LGS',
    desc: 'Paragraf, dil bilgisi, edebiyat — TYT, AYT Eşit Ağırlık ve LGS\'ye hazırlık.',
  ...
  },
  {
    ...
    name: 'Fen Atölyesi',
    sub: 'TYT · AYT-SAY · LGS',
    desc: 'Fizik, Kimya, Biyoloji — TYT temelinden AYT Sayısal düzeyine kadar.',
  ...
  },
  {
    ...
    sub: 'TYT · LGS',
    desc: 'Tarih, Coğrafya, Felsefe — TYT ve LGS Sosyal Bilimler sorularıyla pratik yap.',
  ...
  },
  {
    ...
    sub: 'YDT İngilizce',
    desc: 'Vocabulary, grammar, cloze test — 491 özgün soru ile YDT\'ye tam hazırlık.',
    color: { m: 'var(--focus)', l: 'var(--focus-light)', bg: 'var(--focus-bg)', border: 'var(--focus-border)' },
    count: '491 soru',
    ready: true,
    colorKey: 'focus',
