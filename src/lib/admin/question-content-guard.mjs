...
// matematik/fen kaynağı: data/soru-bankasi/cikmis-katalog/ (481 soru, vision-okuma ile
// çıkarılmış TYT + AYT 2023-2026 kitapçıklarının tamamı; database/analyze-catalog-style.py
// ile ölçüldü). Katalog gitignore'lu — prod'a girmez, yalnız stil-ölçümü kaynağıdır.
export const REF_2026_STYLE = {
  ...
  matematik:
    '2026 YKS-Matematik STİLİ (TYT+AYT 2023-2026, 481-soru analizi; mat: 264/320 metne-ifade-edilebilir, %82): Soruların %66\'sı sayısal-sonuç ister ("...kaçtır?"), %64\'ü "Buna göre..." bağlacıyla kurulur; "hangisi doğrudur/olabilir" tipi %8, olumsuz-kök ("hangisi yanlıştır") %3, I/II/III öncüllü yalnızca %3 — matematikte öncül nadir, fende yaygındır. Senaryo/kişi-adı kullanımı %17: günlük-hayat kurgusu yeni-nesil formatın imzasıdır ama AZINLIKTADIR — soruların çoğunluğu doğrudan cebir/geometri/analiz ifadesidir, her soruyu hikâyeye sarma. Tablo/çizelge atfı %5. Şıklar KISA ve sade (ortalama 4, azami 22 karakter — tam-sayı, sade-kesir veya kök/üstel-form, örn "1/6", "8"); uzun-cümle şık YOK. Cevap dağılımı A-E DENGELİ (45/59/53/59/48) — belirli harfe yığma yapma. Formülleri düz-metin/Unicode yaz (√, ², ×, a/b); GÖRSEL-şekil/çizim gerektiren soru KURMA (platform metin-tabanlı; kitapçıklarda soruların %18\'i şekil-bağımlıydı ve bu yüzden katalog-dışı bırakıldı — sen şekilsiz çözülebilir kur).',
  fen:
    '2026 YKS-Fen STİLİ (TYT+AYT 2023-2026, 481-soru analizi; fen: 217/240 metne-ifade-edilebilir, %90): Soruların %43\'ü "hangisi doğrudur/olabilir" tipi ve %40\'ı I/II/III öncüllü mantık sorusu (çoğunlukla birleşirler), %14\'ü olumsuz-kök ("hangisi yanlıştır/olamaz"); sayısal-sonuç isteyen soru azınlık (%10) — fen ağırlıklı olarak işlem değil SÖZEL-ANALİZ ister, ama fizik/kimyada hesap soruları da meşrudur. SEÇİLEN alt-alana (fizik/kimya/biyoloji) SADIK KAL — kategori-dışı konuya kayma. Şıklar orta-uzun (ortalama 21 karakter, azami ~134 — ama öncüllü sorularda kombinasyon-şıklar "Yalnız I", "I ve II" gibi KISA kalmalı). Senaryo/kişi-adı yalnızca %12, tablo/çizelge atfı %2 — fen kurgusu deney-düzeneği veya olgu-anlatımıdır, günlük-hayat hikâyesi değil. Cevap dağılımı A-E DENGELİ (45/41/42/49/40) — belirli harfe yığma yapma. Sembol/formül Unicode yaz; saf-geometri/devre/şekil gerektiren soru KURMA (platform metin-tabanlı; kitapçıklarda soruların %10\'u şekil-bağımlıydı ve bu yüzden katalog-dışı bırakıldı).',
}
