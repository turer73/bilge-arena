...
export const REHBER_ARTICLES: RehberArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Soru 2: Aşağıdaki sayılardan hangisi hem 4\'e hem 9\'a bölünür? A) 3.612  B) 5.148  C) 7.236  D) 8.140  E) 2.925. Çözüm: Önce 9 filtresi (rakam toplamı 9\'un katı) daha ayırt edicidir: 5.148 sayısında 5+1+4+8=18, 9\'a bölünür. Son iki basamağı "48", 48÷4=12 olduğundan 4\'e de bölünür. Diğerlerini kontrol edince 4 ve 9 şartını aynı anda yalnızca 5.148 sağlar. Cevap: B) 5.148.',
      ...
      'Kısa özet: 2, 5, 10 için birler basamağına; 3, 9 için rakam toplamına; 4, 8 için son basamaklara; 11 için alternatif toplama bak. 6, 12, 15 gibi sayıları asal çarpanlarına ayırıp parça parça kontrol et. Bu kuralları hızlı uygulamak, TYT\'de sana saniyeler kazandırır — ve sınavda saniyeler nettir.',
