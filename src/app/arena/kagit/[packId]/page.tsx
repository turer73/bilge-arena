...
import { z } from 'zod'
import { PaperPackClient } from './paper-pack-client'

export const metadata: Metadata = {
  title: 'Yazdırılabilir Kağıt Paketi',
  robots: { index: false, follow: false },
}

export default async function PaperPackPage({ params }: { params: Promise<{ packId: string }> }) {
  ...
  if (process.env.NEXT_PUBLIC_PAPER_MODE_ENABLED !== 'true' || !valid) {
    return (
      <div className="mx-auto max-w-lg px-4 py-16 text-center">
        <h1 className="text-xl font-black">Paket kullanılamıyor</h1>
  ...
  return <PaperPackClient packId={packId} />
}
