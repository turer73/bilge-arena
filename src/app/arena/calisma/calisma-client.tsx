  ...
  return (
    <div data-practice-screen className="min-h-[100dvh] w-full min-w-0 touch-pan-y overflow-x-clip bg-[var(--app-bg)] pb-24 text-[var(--app-text)] lg:bg-transparent lg:pb-10">
      ...
      <div className="mx-auto w-full min-w-0 max-w-[1180px] px-3 pt-3 md:px-5 lg:px-6 lg:pt-0">
        <div data-practice-overview className="flex min-w-0 flex-col gap-4 lg:grid lg:grid-cols-[minmax(0,1fr)_420px] lg:items-start lg:gap-6">
          <main data-practice-main-column className="contents lg:block lg:min-w-0">
            <section data-practice-focus aria-labelledby="practice-hero-title" className="relative order-1 min-h-[168px] min-w-0 self-start overflow-hidden rounded-[26px] bg-gradient-to-br from-[var(--app-accent)] to-[var(--app-accent-strong)] p-4 text-white shadow-[0_6px_0_var(--app-shadow-accent)] md:min-h-[176px] md:p-6 lg:min-h-[154px] lg:py-5">
            ...
            <section aria-label="Çalışma planın" className="order-3 min-w-0 space-y-4 lg:mt-4">
              <TodayPlanFocus
                game={game}
                userId={user.id}
                examRef={examRef}
          ...
          <aside data-practice-side-column className="contents lg:sticky lg:top-[calc(var(--navbar-h)+1.5rem)] lg:block lg:min-w-0">
            ...
            <div className="order-4 min-w-0 lg:mt-4">
