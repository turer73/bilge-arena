...
export default function ArenaLayout({
  ...
  return (
    <>
      ...
      <main data-arena-main className="min-h-screen w-full min-w-0 overflow-x-clip scroll-pb-[calc(var(--bottom-nav-h)+env(safe-area-inset-bottom))] pt-[var(--navbar-h)] pb-[calc(var(--bottom-nav-h)+env(safe-area-inset-bottom))] lg:scroll-pb-0 lg:pb-0">
        {children}
      </main>
      <ArenaAuxiliaries />
      <BottomNav />
